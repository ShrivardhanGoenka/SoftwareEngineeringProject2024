...
function Profile() {
  ...
  return (
    <div className="flex flex-col pb-2 mx-auto w-auto h-dvh bg-violet-100">
      ...
      className="flex flex-col shrink-0 mt-8 rounded-full border border-black border-solid mx-auto aspect-[1.06] w-[62px] shadow-md"
      /> */}
      ...
      <div className="flex flex-col">
        ...
        <button onClick={onLogout} className='mt-4 mx-4 text-blue-700 font-semibold hover:text-white py-2 px-4 bg-transparent hover:bg-indigo-500 border border-indigo-500 hover:border-transparent rounded shadow-md'>Log out</button>
      </div>
    </div>
  )
}
