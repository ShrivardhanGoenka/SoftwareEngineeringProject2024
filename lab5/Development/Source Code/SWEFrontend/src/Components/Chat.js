...
// Chat component
// This component is used to display the chat messages and send messages
// @param role - role of the user. Either "requester" or "driver"
// @returns JSX
// The function sets up a polling mechanism to fetch chat messages every 500ms
// The function also provides a text input to send messages
// The function calls the sendChatMessage function to send messages and getChatMessages to fetch messages
// The polling mechanism is cleared when the component is unmounted
function Chat({ role }) {
