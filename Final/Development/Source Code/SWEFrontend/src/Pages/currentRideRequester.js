...
// CurrentRideRequester component is used to display the current ride details of the user
// The component fetches the current ride details of the user using the getCurrentRideInfo function
// The component displays the current ride details of the user
// The component displays the pickup location, destination, service type, transaction amount, and driver name of the ride
// The component displays the car model, car plate, and car colour of the driver
// The component displays the status of the ride
// The component displays a map with the route from the driver location to the pickup location or destination
// The component allows the user to chat with the driver
// The component will show a success message if the ride is completed successfully
// The component will redirect the user to the feedback page after the ride is completed
