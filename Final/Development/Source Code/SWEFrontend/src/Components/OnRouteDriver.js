...
// This component is used to display the map view for the driver to see the route from the pickup location to the destination location
// @returns JSX
...
// If the current location is not available, it displays the destination location marker
// The function provides a button to confirm the ride completion
// The function navigates to the feedback page when the ride is completed
