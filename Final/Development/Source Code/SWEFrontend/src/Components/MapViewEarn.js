...
// This component is used to display the map view for the user to see the route from the pickup location to the destination location
// @param location - location state
// @param setLocation - function to update the location state
// @param pickupLocation - pickup location state
