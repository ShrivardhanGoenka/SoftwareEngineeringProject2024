    ...
    return (
        <div className="flex flex-col items-center justify-center bg-violet-100 h-screen ">
                <div className="font-semibold text-4xl mt-7 md:mt-10 mb-4">Sign Up</div>
                    ...
                    <button className='w-[80%] mt-10 py-2 px-6 font-semibold hover:text-white bg-white hover:bg-indigo-500 border border-indigo-500 hover:border-transparent rounded-full shadow-md' onClick={handleSubmit}>Submit</button>
        </div>
    );
}
